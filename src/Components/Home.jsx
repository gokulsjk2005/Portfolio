    ...
    <div className="home">
        <div className="min-h-[200px] w-full flex flex-col sm:flex-row sm:justify-center sm:gap-5 md:gap-12 xl:gap-32 pt-32 items-center bg-linear-to-b from-primary-200 to-primary-100 px-6 sm:px-5 lg:px-10 lg:pt-40">
            <div className="left text-white">
                ...
                <button href="#about" className="bg-white my-3 xs:my-5 flex gap-2 text-primary-100 font-semibold text-md xs:text-lg sm:text-sm md:text-lg px-4 py-2 rounded-lg shadow-md hover:bg-gray-200 transition duration-300">Resume <img src={download} className='sm:w-5 md:w-auto' /></button>
            </div>
