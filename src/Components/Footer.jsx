    ...
    <div className="footer w-full m-0 bg-black">
        <div className="footer1 flex flex-col sm:flex-row  px-10 py-8">
            ...
            <div className="right flex justify-start xs:justify-center xs:items-center gap-6 py-5 sm:w-1/2">
                <img src={linkedIn} className="w-6 h-6 sm:w-8 sm:h-8" />
                <img src={insta} className="w-6 h-6 sm:w-8 sm:h-8" />
                <img src={github} className="w-6 h-6 sm:w-8 sm:h-8" />
            </div>
        </div>
        <hr className='border-neutral-700 ' />
        <div className="footer2 px-5 py-3 text-center">
            <p className='text-neutral-500 text-xs md:text-sm tracking-widest'>©2024 Gokul Krishna S J K | All rights reserved</p>
        </div>
    </div>
  )
}
