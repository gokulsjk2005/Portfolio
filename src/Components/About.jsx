        ...
        <div className="aboutSection min-h-[500px] pt-10 pb-15 px-6 sm:px-12 md:px-6 lg:px-20 xl:px-32 bg-gray-100">
            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="right md:w-1/2 md:py-20 lg:py-15">
                    <p className='my-5 text-lg text-gray-800 xs:px-5 sm:text-xl md:text-lg lg:text-xl xl:text-2xl'>Hi! I'm
                        <span className='text-xl sm:text-2xl md:text-lg lg:text-xl xl:text-2xl font-medium italic'> Gokul Krishna S J K,
