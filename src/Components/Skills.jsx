...
const skills = {
    HTML: html, CSS: css, JavaScript: js, ReactJS: react, TailwindCSS: tailwind, Git: git, GitHub: github, Bootstrap: bootstrap, NodeJS: nodejs, jQuery: jquery, Sass: sass, VSCode: vscode
};

const Skills = () => {
  return (
    <div className="skills flex justify-center min-h-[300px] bg-white px-10 sm:px-10 lg:px-20 pb-10">
