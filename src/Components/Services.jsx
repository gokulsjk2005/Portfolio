...
const Services = () => {
  ...
  return (
    ...
    <div className="services" id='services'>
        ...
        <div className="servicess flex justify-center min-h-[300px] bg-white px-5 sm:px-10 lg:px-20 py-10 pt-10 pb-15">
        <div className="services-container w-full max-w-6xl">
